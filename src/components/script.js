  ...
  <h3>
    <svg className="prefix__subtitle" viewBox="0 0 229.2 69.6" {...props}>
      ...
      <path
        className="prefix__path"
        clipPath="url(#prefix__a)"
        d="M150.24 20.5S138 26.75 136 31.75s-4.07 5 .43 13.1a9.25 9.25 0 01-.18 7.15c-1.75 3.5-2 9.75-7.75 5.75S134.24 42 150.24 37.5c0 0 4.41-4.3 8.51-8.6s-17.5 26-15.88 31.9l30.63-25.61 12.65-26.06s-28 50.42-25.1 51S178.75 38 195.5 41c0 0 20.9-14.33 5-15.75 0 0-26.5 15.25-17 31.25 0 0 8.5 3 18-4.5s22.5-21.2 24.75-4.1"
        fill="none"
        stroke="#FFF"
        strokeWidth={10}
      />
